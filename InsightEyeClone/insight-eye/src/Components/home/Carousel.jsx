...
const Carousel = () => {
 ...
 return (
    <div className="w-full relative">
        ...
        >
            ...
            <SwiperSlide key={slide.id}>
                ...
                <div className='absolute left-[40%] bottom-0'>
                    ...
                    <div className='absolute top-28 left-20 text-white p-8 w-1/2'>
        ...
        <div className='absolute -bottom-52 left-0 w-full h-1/2 z-50'>
            <div className='max-w-7xl  m-auto  bg-white py-12 px-8 shadow-lg'>
                <div className='flex justify-around'>
                    {carouselLowerData.map((data) => (
                        <div key={data.id} className='flex items-center space-x-4 w-[47%] bg-gray-100 p-8'>
                            <span className='text-4xl text-secondary  p-4 bg-white hover:text-white hover:bg-customGradient rounded-full border-2'>{data.icons}</span>
